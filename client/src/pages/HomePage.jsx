      ...
      <div className="container-fluid Homebackground4">
        <div className="row">
          <div className="col-6">
            <br />
            <br />
            <h1 className="font1">Trending & New</h1>
            <br />
            <br />
            <div>
              <img className="img-m2" src="img/Handcraft3.png" />
              <br />
              <br />
            </div>
          </div>
      ...
      <div className="container-fluid Homebackground5">
        <div className="row">
          <div className="col-6">
            ...
            <br />
            <p className="txtSize">
              Dhokra Metal Craft. Dhokra is amongst the oldest traditional
              techniques of metal casting in India, practiced for over 4,000
              years, said to date back to the era of the Indus Valley
              Civilisation. The lost wax technique or ‘cire-perdue’ has been the
              medium of metal workers in Madhya Pradesh, Chhattisgarh, Orissa
              and West Bengal. Entirely handcrafted, the unique 13-stage process
              of Dhokra /Bell-metal making today, is an outcome of the original
              craft instinct handed down through the centuries. Dhokra or Bell
              metal is an alloy of brass, and other metals that impart an
              antique effect to the castings.
            </p>
            <br />
            <br />
          </div>
          <div className="col-6">
            <div>
              <br />
              <br />
              <img className="img5" src="img/product9.jpg" />
              <br />
              <br />
            </div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-6">
            ...
            <p className="txtSize">
              ...
              item or a large assortment of multiple craft products, we can sort
              it out for you! For years we have also worked on custom orders for
              our clients – it is one of the many benefits of having direct
